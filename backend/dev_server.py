...
def ingest_config(config: str):
    ...
    try:
        ...
        with open(config, 'r') as file:
            ...
            if root is None:
                log_error("Error parsing configuration file: Empty or invalid XML file")
                # print("Empty or invalid XML file.")  # Handle an empty or invalid XML file
                return server_info, net_systems, None
    except FileNotFoundError as file_error:
        log_error("Error parsing configuration file: ", str(file_error))
        # print("File not found.")  # Handle file not found
        return server_info, net_systems, None
    except Exception as e:
        log_error("Error parsing configuration file: ", str(e))
	...
	return None, None
        ...
        log_error("Error saving configuration file: ", str(e))
...
def convert_alert_XML(alerts: list):
    try: 
        ...
        log_error("Error exporting to XML: ", str(e))
...
def convert_alert_JSON(alerts: list):
	...
	file.write(alert_data)
        ...
        log_error("Error exporting to JSON: ", str(e))
...
def convert_alert_CSV(alerts: list):
	...
	writer.writerows(alerts_data)
        ...
        log_error("Error exporting to CSV: ", str(e))

# notify_alert()
# display_alert()
# display_node_list()

def manage_connections(server_info: dict, system_info: dict):
    try:
	...
	client_handler_thread.start()
        ...
        log_error("Error with server-client connection: ", str(e))
...
def decrypt_alert(encrypted_alert):
    ...
    try:
        ...
        log_error("Error decoding JSON: ", str(e))
...
def receive_alert(client_socket):
	...
	client_socket.close()
        ...
        log_error("Error recieving alerts from client: ", str(e))
...
def process_alert(alert):
    ...
    try:
        ...
        log_error("Error adding alert to alerts list: ", str(e))
...
def handle_client(client_socket):
    try:
        ...
        log_error("Error handling client connection: ", str(e))
    finally:
        client_socket.close()
