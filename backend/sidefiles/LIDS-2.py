...
class LIDS:
    ...
    def connect_server(self, system_info: dict):
        # try:
        ...
        self.sniff_traffic(self.server_info, system_info, capture_interface)

        # except socket.error as e:
        #     print("Error connecting to the server:", str(e))

    def sniff_traffic(self, system_info: dict, capture_interface: str) -> None:
            ...
            with pyshark.FileCapture(pcap_file, keep_packets=True) as capture:
                ...
                for captured_packet in capture:
                    try:
                        ...
                        created_packet = self.create_packet(captured_packet)
                        self.analyze_packet(created_packet, system_info)
    ...
    def analyze_packet(self, packet, system_info):
        ...
        if packet['header']['srcPort'] == '21' and "530 Login incorrect" in packet['payload']:
            ...
            self.create_alert(packet,6)

    def create_alert(self,packet, num):
        if num == 1:
